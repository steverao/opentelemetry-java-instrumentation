...
public abstract class SpymemcachedRequest {
  ...
  public static SpymemcachedRequest create(MemcachedConnection connection, String statement) {
    return new AutoValue_SpymemcachedRequest(connection, statement, null);
  }

  public static SpymemcachedRequest create(MemcachedConnection connection, String statement, @Nullable MemcachedNode handlingNode) {
