    ...
    public static void methodExit(
      ...
      if (future != null) {
        GetCompletionListener listener =
            GetCompletionListener.create(currentContext(), client.getConnection(), methodName, future);
        if (listener != null) {
          future.addListener(listener);
        }
      }
    ...
    public static void methodExit(
      ...
      if (future != null) {
        BulkGetCompletionListener listener =
            BulkGetCompletionListener.create(currentContext(), client.getConnection(), methodName, (net.spy.memcached.internal.BulkGetFuture<?>) future);
        if (listener != null) {
          future.addListener(listener);
        }
      }
    ...
    public static class AdviceScope {
      ...
      public static AdviceScope start(MemcachedClient client, String methodName, String key) {
        ...
        return new AdviceScope(
            callDepth,
            SyncCompletionListener.create(Context.current(), client.getConnection(), methodName, key));
      }
